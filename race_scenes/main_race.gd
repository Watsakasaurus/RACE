...
func racer1CheckPos():
	if (global.selectedCharacter == 1):
		if (checkVector1 >= Vector2(1140,64)):
			if(checkVector2 >= Vector2(1135,128)): # slightly reduced x coordinate to account for the deltas discrepancies between dead heats
				global.finishPosition += 1
			if(checkVector3 >= Vector2(1135,192)):
				global.finishPosition += 1
			if(checkVector4 >= Vector2(1135,256)):
				global.finishPosition += 1
			if(checkVector5 >= Vector2(1135,320)):
				global.finishPosition += 1
			if(checkVector6 >= Vector2(1135,384)):
				global.finishPosition += 1
...
func racer2CheckPos():
	if (global.selectedCharacter == 2):
		if (checkVector2 >= Vector2(1140,128)):
			if(checkVector1 >= Vector2(1135,64)):
				global.finishPosition += 1
			if(checkVector3 >= Vector2(1135,192)):
				global.finishPosition += 1
			if(checkVector4 >= Vector2(1135,256)):
...
func racer3CheckPos():
	if (global.selectedCharacter == 3):
		if (checkVector3 >= Vector2(1140,192)):
			if(checkVector1 >= Vector2(1135,64)):
				global.finishPosition += 1
			if(checkVector2 >= Vector2(1135,128)):
				global.finishPosition += 1
			if(checkVector4 >= Vector2(1135,256)):
				global.finishPosition += 1
			if(checkVector5 >= Vector2(1135,320)):
